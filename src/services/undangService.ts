/**
 * UNDANG-UNDANG Service
 * Service untuk menangani chat AI untuk bidang hukum dan regulasi
...
export const initializeSession = () => {
  if (!currentSessionId) {
    ...
    console.log('UNDANG: Created new session ID:', currentSessionId);
  } else {
    console.log('UNDANG: Using existing session ID:', currentSessionId);
  }
};
...
export const clearChatHistory = () => {
  console.log('UNDANG: Clearing chat history and session');

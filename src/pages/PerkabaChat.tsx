...
import { perkabaAgents } from '../data/perkabaAgents';
...
export default function PerkabaChat() {
  ...
  const selectedAgentData = perkabaAgents.find(agent => agent.id === selectedAgent);
  ...
  const renderContent = () => {
    ...
    if (selectedAgentData.type === 'perkaba_chat') {
      ...
      <div className="min-h-screen dark:bg-black bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative">
        ...
        <div className={`relative z-10 p-6 lg:p-8 transition-all duration-300 ${showArtifact ? 'lg:mr-[50%]' : ''}`}>
          ...
          <div className="max-w-4xl mx-auto">
            {selectedAgentData.type === 'perkaba_chat' ? (
              renderContent()
            ) : (
            ...
            {isProcessing && selectedAgentData.type !== 'perkaba_chat' && (
        ...
        {showArtifact && result && selectedAgentData.type !== 'perkaba_chat' && (
          <ResultArtifact 
            content={result}
            onClose={() => {
              setShowArtifact(false);
    ...
    <div className="min-h-screen dark:bg-black bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative">
      ...
      <div className="relative z-10 p-6 lg:p-8">
          ...
          <div className="max-w-5xl mx-auto px-6 py-8">
            <div className="max-w-2xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Perkaba Chat</h1>
              </div>
              <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 ml-11">
                Pilih agen AI untuk membantu pencarian dan analisis Perkaba
              </p>
            </div>
          </div>
        </header>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
          {perkabaAgents.map((agent: ExtendedAgent) => (
            <div 
              key={agent.id}

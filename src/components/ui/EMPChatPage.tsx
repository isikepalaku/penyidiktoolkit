...
const EMPChatPage: React.FC<EMPChatPageProps> = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    setMessages([
      {
        content: 'Asisten Ai yang bertugas untuk membantu menjawab hal-hal seputar aplikasi EMP berdasarkan perkaba Polri, silahkan tulis pertanyaan anda?',
        type: 'bot',
        timestamp: new Date()
      }
    ]);
  ...
  const formatMessage = (content: string) => {
    ...
    formattedContent = formattedContent.replace(/<\/ul><ul class="my-1">/g, '');
    ...
    formattedContent = formattedContent.replace(/<\/ol><ol class="my-1">/g, '');
  ...
  const exampleQuestions = [
    "Apa yang dimaksud dengan tindak pidana pencucian uang dalam konteks perbankan?",
    "Bagaimana prosedur tanda tangan elektronik Direktur dalam sistem EMP?",
    "Jelaskan tentang tindak pidana perbankan menurut UU Perbankan",
    "Bagaimana cara melakukan reset password aplikasi EMP?"
  ];
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center justify-center w-9 h-9 bg-blue-100 rounded-full">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Asisten perkaba Polri aplikasi EMP</p>
              </div>
            </div>
          </div>
          <button 
        ...
        {showInfo && (
          <div className="bg-blue-50 border-b border-blue-200 p-3 text-sm text-blue-800">
            <div className="max-w-3xl mx-auto">
              ...
              <p>EMP AI adalah Asisten perkaba Polri aplikasi EMP.</p>
              <p className="mt-2 text-xs text-blue-600">Catatan: EMP AI dapat memberikan informasi yang tidak akurat. Verifikasi fakta penting.</p>
            </div>
          </div>
        )}
        ...
        <div className="border-t border-gray-200 bg-white p-4 md:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              EMP AI dapat memberikan informasi yang tidak akurat. Verifikasi fakta penting.
            </p>
          </div>
        </div>
      </div>

...
import { sendChatMessage, clearChatHistory, initializeSession } from '@/services/empService';
...
const EMPChatPage: React.FC<EMPChatPageProps> = ({ onBack }) => {
  ...
  const exampleQuestions = [
    "Apa yang dimaksud dengan EMP?",
    "Bagaimana prosedur tanda tangan elektronik direktur?",
    "Bagaimana prosedur lupa password aplikasi EMP",
    "Apa kontak utama admin EMP pusat?"
  ];
      ...
      <div className="flex flex-col flex-1 h-full overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900">EMP AI</h2>
                <p className="text-xs text-gray-500">Asisten aplikasi EMP berdasarkan perkaba Polri</p>
              </div>
            </div>
          </div>
          <button 
        ...
        {showInfo && (
          <div className="bg-amber-50 border-b border-amber-200 p-3 text-sm text-amber-800">
            <div className="max-w-3xl mx-auto">
              <p className="mb-2"><strong>Tentang EMP AI:</strong></p>
              <p>EMP AI adalah asisten yang memberikan informasi tentang aplikasi EMP berdasarkan perkaba Polri.</p>
              <p className="mt-2 text-xs text-amber-600">Catatan: EMP AI dapat memberikan informasi yang tidak akurat. Verifikasi fakta penting dengan dokumen resmi.</p>
            </div>
          </div>
        )}
        ...
        >
          ...
          <div className="max-w-3xl mx-auto relative z-10 space-y-6">
            {/* Welcome Message - Bold EMP AI in center */}
            {messages.length <= 1 && (
              <div className="flex flex-col items-center justify-center h-[50vh] text-center">
                ...
                <h1 className="text-4xl font-bold text-amber-600 mb-4">EMP AI</h1>
                <p className="text-gray-600 max-w-md">
                  Asisten untuk membantu Anda dengan pertanyaan seputar aplikasi EMP berdasarkan perkaba Polri
                </p>
              </div>
            )}
          ...
          <div className="max-w-3xl mx-auto">
            <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="relative">
              <Textarea
                ...
                className="resize-none pl-4 pr-12 py-3 max-h-[200px] rounded-xl border-gray-300 focus:border-amber-500 focus:ring-amber-500 shadow-sm overflow-y-auto z-10"
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              EMP AI dapat memberikan informasi yang tidak akurat. Verifikasi fakta penting dengan dokumen resmi.
            </p>
          </div>
        </div>
      </div>

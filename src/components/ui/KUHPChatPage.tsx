...
import { ArrowLeft, Send, Copy, Check, Loader2, BookOpen, Info, X, ChevronDown, RefreshCw, Paperclip, File, XIcon, AlertCircle, Clock } from 'lucide-react';
import { cn } from '@/utils/utils';
import { Button } from './button';
import { Textarea } from './textarea';
import { DotBackground } from './DotBackground';
import { sendChatMessage, clearChatHistory, initializeSession, onProgress } from '@/services/kuhpService';
...
const KUHPChatPage: React.FC<KUHPChatPageProps> = ({ onBack }) => {
  ...
  if (hasError) {
    return (
      <ErrorScreen
        title="Ahli Pidana"
        subtitle="Kitab Undang-Undang Hukum Pidana"
        onBack={onBack}
        onRetry={handleRetry}
      ...
      <header className="flex items-center justify-between p-4 border-b border-gray-200 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 hidden sm:block">Kitab Undang-Undang Hukum Pidana</p>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-rose-700">
                <p>Ahli Pidana adalah asisten berbasis kecerdasan buatan untuk membantu memahami Kitab Undang-Undang Hukum Pidana (KUHP). 
                ...
                Informasi yang diberikan bersifat umum dan sebaiknya dikonfirmasi dengan sumber resmi atau konsultasi dengan ahli hukum yang berkualifikasi.</p>
              </div>
              <button 
          ...
          <div className="max-w-5xl mx-auto px-4 md:px-8 space-y-6">
            ...
            {messages.length <= 1 && messages[0].content === '' && (
              <div className="flex flex-col items-center justify-center h-[50vh] text-center">
                ...
                <h1 className="text-4xl font-bold text-rose-600 mb-4">Ahli Pidana</h1>
                <p className="text-gray-600 max-w-md">
                  Asisten Ai spesialisasi hukum pidana.
                </p>
              </div>
            )}
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          ...
          {selectedFiles.length > 0 && (
            <div className="mb-3 flex flex-wrap gap-2">
              {selectedFiles.map((file, index) => (
                <div 
                  key={index}
                  className="bg-rose-50 border border-rose-200 rounded-lg px-3 py-1 flex items-center gap-2 text-sm text-rose-700"
                >
          ...
          <div className="relative">
            <Textarea
              ...
              className="resize-none pr-12 py-3 pl-10 max-h-[200px] rounded-xl border-gray-300 focus:border-rose-500 focus:ring-rose-500 shadow-sm overflow-y-auto z-10"
            ...
            <button
              ...
              disabled={isProcessing}
              className="absolute left-2 bottom-3 p-2 rounded-lg text-gray-500 hover:text-rose-500 hover:bg-rose-50 transition-colors z-20"
          ...
          <p className="text-xs text-gray-500 mt-2 text-center">
            Ahli Pidana memberikan informasi umum dan tidak bisa menggantikan nasihat hukum profesional.
          </p>
        </div>
      </div>
    </div>

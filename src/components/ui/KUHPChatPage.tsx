  ...
  return (
    <div className="fixed inset-0 z-20 bg-white lg:pl-64">
      ...
      <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Asisten UU No. 1 Tahun 2023 tentang KUHP</p>
              </div>
            </div>
          </div>
          <button 
        ...
        {/* Info Panel */}
        {showInfo && (
          <div className="bg-rose-50 border-b border-rose-200 p-3 text-sm text-rose-800">
                ...
                >
                  {message.isAnimating ? (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-500">KUHP AI sedang mengetik...</span>
                    </div>
                  ) : message.type === 'bot' ? (

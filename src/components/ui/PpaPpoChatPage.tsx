...
const PpaPpoChatPage: React.FC<PpaPpoChatPageProps> = ({ onBack }) => {
  ...
  const exampleQuestions = [
    "Apa saja jenis-jenis kekerasan terhadap perempuan menurut UU?",
    "Bagaimana prosedur penanganan kasus kekerasan terhadap anak?",
    "Apa kriteria tindak pidana perdagangan orang menurut hukum Indonesia?",
    "Apa hak-hak korban KDRT dalam proses hukum?"
  ];

        ...
        <header className="flex items-center justify-between p-4 border-b border-gray-200 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 hidden sm:block">Asisten untuk industri dan perdagangan</p>
            </div>
          </div>
        </header>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-purple-700">
                <p>INDAGSI AI merupakan asisten kepolisian yang membantu dalam penanganan tindak pidana industri dan perdagangan. Asisten ini dapat menjawab pertanyaan terkait UU terkait, penyelidikan kasus, dan penanganan kasus-kasus tindak pidana di bidang industri dan perdagangan.</p>
              </div>
              <button 
            ...
            {messages.length <= 1 && messages[0].content === '' && (
              <div className="flex flex-col items-center justify-center h-[50vh] text-center">
                ...
                <p className="text-gray-600 max-w-md">
                  Asisten untuk membantu Anda dengan pertanyaan seputar tindak pidana industri dan perdagangan.
                </p>
              </div>
            )}
        ...
        <div className="max-w-3xl mx-auto">
          <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="relative">
            <Textarea
              ...
              className="pl-4 pr-12 py-3 max-h-[200px] rounded-xl border border-gray-300 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 resize-none overflow-y-auto"
              disabled={isProcessing}
            />
            <Button 
              type="submit"
              size="icon"
              className="absolute bottom-2.5 right-2.5 h-8 w-8 bg-purple-600 hover:bg-purple-700 text-white rounded-lg"

...
const IndagsiChatPage: React.FC<IndagsiChatPageProps> = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    setMessages([
      {
        content: 'Halo, saya Indagsi AI, asisten untuk membantu Anda dengan pertanyaan seputar tindak pidana di bidang Industri dan Perdagangan. Apa yang ingin Anda tanyakan?',
        type: 'bot',
        timestamp: new Date(),
      },
    ]);
          ...
          <div className="max-w-3xl mx-auto">
            <div className="flex items-end gap-2">
              ...
              <Button
                ...
                className="rounded-full p-3 h-auto aspect-square bg-purple-600 hover:bg-purple-700 text-white"

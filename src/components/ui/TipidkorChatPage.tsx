          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center justify-center w-9 h-9 bg-blue-100 rounded-full">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Asisten tindak pidana korupsi</p>
              </div>
            </div>
          </div>
          <button 
        ...
        {showInfo && (
          <div className="bg-red-50 border-b border-red-200 p-3 text-sm text-red-800">
            <div className="max-w-3xl mx-auto">
              <p className="mb-2"><strong>Tentang Tipidkor AI:</strong></p>
              <p>Tipidkor AI adalah asisten yang dirancang untuk membantu Anda dengan pertanyaan seputar tindak pidana korupsi.</p>
              <p className="mt-2 text-xs text-red-600">Catatan: Tipidkor AI dapat memberikan informasi yang tidak akurat. Verifikasi fakta penting.</p>
            </div>
          </div>
        )}
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative">
              <Textarea
                ...
                className="resize-none pr-12 py-3 min-h-[56px] max-h-[200px] rounded-xl border-gray-300 focus:border-red-500 focus:ring-red-500 shadow-sm"
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              Tipidkor AI dapat memberikan informasi yang tidak akurat. Verifikasi fakta penting.
            </p>
          </div>
        </div>
      </div>

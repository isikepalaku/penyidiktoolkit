...
const FismondevChatPage: React.FC<FismondevChatPageProps> = ({ onBack }) => {
  ...
  return (
    <div className="fixed inset-0 z-20 bg-white lg:pl-64 flex flex-col">
      ...
      {showInfo && (
        <div className="bg-green-50 border-l-4 border-green-500 p-4 m-4 shadow-sm rounded-md">
          <div className="flex">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {exampleQuestions.map((question, idx) => (
                    <button
                      key={idx}
                      className="text-left p-3 border border-gray-200 rounded-lg text-gray-700 hover:bg-green-50 transition-colors shadow-sm"
        ...
        <div className="max-w-3xl mx-auto">
          <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="relative">
            <Textarea
              ...
              className="pl-4 pr-12 py-3 min-h-[56px] max-h-[200px] rounded-xl border border-gray-300 focus:border-green-500 focus:ring-1 focus:ring-green-500 resize-none"

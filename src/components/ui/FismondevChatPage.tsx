...
import { ArrowLeft, Send, Copy, Check, Loader2, DollarSign, Info, X } from 'lucide-react';
...
const FismondevChatPage: React.FC<FismondevChatPageProps> = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    setMessages([
      {
        content: 'Halo, saya Fismondev AI, asisten untuk membantu Anda dengan pertanyaan seputar tindak pidana di bidang Fiskal, Moneter, dan Devisa. Apa yang ingin Anda tanyakan?',
        type: 'bot',
        timestamp: new Date(),
      },
    ]);

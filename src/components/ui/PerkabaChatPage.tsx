...
const PerkabaChatPage: React.FC<PerkabaChatPageProps> = ({ onBack }) => {
  ...
  const exampleQuestions = [
    ...
    "Bagaimana prosedur pemanggilan saksi menurut Perkaba?",
      ...
      <div className="flex flex-col flex-1 h-full overflow-hidden">
        ...
        {showInfo && (
          <div className="bg-purple-50 border-b border-purple-200 p-3 text-sm text-purple-800">
            <div className="max-w-3xl mx-auto">
              ...
              <p>SOP Lidik Sidik AI adalah asisten yang memberikan informasi tentang Standar Operasional Prosedur (SOP) Lidik Sidik berdasarkan Perkaba Polri.</p>
        ...
        >
          ...
          <div className="max-w-3xl mx-auto relative z-10 space-y-6">
            {/* Welcome Message - Bold SOP LIDIK SIDIK AI in center */}
            {messages.length <= 1 && (
              <div className="flex flex-col items-center justify-center h-[50vh] text-center">
                ...
                <h1 className="text-4xl font-bold text-purple-600 mb-4">SOP LIDIK SIDIK AI</h1>
                <p className="text-gray-600 max-w-md">
                  Asisten untuk membantu Anda dengan pertanyaan seputar SOP Lidik Sidik berdasarkan Perkaba Polri.
                </p>
              </div>
            )}
                    ...
                    >
                      {message.type === 'bot' && (
                        <div className="flex-shrink-0 mr-2 mb-1">
                           ...
                           {message.isAnimating ? (
                            <AnimatedBotIcon className="w-8 h-8 text-purple-600" />
                          ) : (
                                ...
                                <ul className="text-xs text-gray-500 space-y-1">
                                  {message.sourceDocuments.map((doc, idx) => (
                                    <li key={idx} className="break-all">
                                      ...
                                      {doc.metadata.source || doc.metadata.title || 'Dokumen Perkaba'}
                                    </li>
                                  ))}
                                </ul>
                              </div>
          ...
          <div className="max-w-3xl mx-auto">
            <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="relative">
              <Textarea
                ...
                className="resize-none pl-4 pr-12 py-3 max-h-[200px] rounded-xl border-gray-300 focus:border-purple-500 focus:ring-purple-500 shadow-sm overflow-y-auto z-10"
